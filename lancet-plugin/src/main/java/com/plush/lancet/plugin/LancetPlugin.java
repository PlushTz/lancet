    ...
    public void apply(Project project) {
        ...
        if (project.getRootProject().file("gradle.properties").exists()) {
            try {
                ...
                disableSensorsAnalyticsPlugin = Boolean.parseBoolean(properties.getProperty("lancet.disablePlugin", "false")) || Boolean.parseBoolean(properties.getProperty("lancet.disablePlugin", "false"));
            } catch (Exception e) {
