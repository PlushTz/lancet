...
public class TransformContext {
    ...
    public File getRelativeFile(QualifiedContent content) {
        return invocation.getOutputProvider().getContentLocation(content.getName(), content.getContentTypes(), content.getScopes(), (content instanceof JarInput ? Format.JAR : Format.DIRECTORY));
    }
    ...
    public String toString() {
        return "TransformContext{" + "allJars=" + allJars + ", addedJars=" + addedJars + ", removedJars=" + removedJars + ", changedJars=" + changedJars + ", allDirs=" + allDirs + '}';
    }
}
